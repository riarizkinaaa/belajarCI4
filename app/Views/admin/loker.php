                ...
                <div class="col-sm">
                    ...
                    <div id="exampleModal" class="modal fade custom-modal" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            ...
                            <form action="<?= base_url('/admin/loker/tambah'); ?>" method="post">
                                <?= csrf_field(); ?>
            ...
            <?php foreach ($joinAll as $lok => $value) : ?>
                <div id="modalEdit<?= $value['id_loker'] ?>" class="modal fade custom-modal custom-modal-verify-account">
                    <div class="modal-dialog" role="document">
                        ...
                        <form action="<?= base_url('/admin/loker/edit/' . $value['id_loker']) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="modal-content">
                                <div class="mt-2">
                                    <div class="container-fluid">
                                    ...
                                    <div class="col-sm-50">
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div class="justify-content-start ml-5">
                                                    <a href="<?= base_url('/admin/loker/hapus/' . $value['id_loker']) ?>" class="btn btn-info">Ya</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
